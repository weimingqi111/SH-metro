...
from lib.datasets.dataset.crowed import crowedhuman
...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 2 or dataset == 'sh':
      self.names = SH_class_name
    elif num_classes == 2 or dataset == 'cb':
      self.names = cb_class_name
    elif num_classes == 2 or dataset == 'crowedhuman':
      self.names = crowedhuman_class_name
    elif num_classes == 2 or dataset == 'citypersons':
      self.names = citypersons_class_name
  ...
  def add_coco_bbox(self, bbox, cat, conf=1, show_txt=True, img_id='default'): 
    ...
    if show_txt:
      ...
      cv2.putText(self.imgs[img_id], txt, (bbox[0], bbox[1] - 2), 
                font, 0.5, (0, 0, 0), thickness=0, lineType=cv2.LINE_AA)
...
SH_class_name = ['person', 'head']
cb_class_name = ['person', 'head']
crowedhuman_class_name = ['person', 'head']
citypersons_class_name = ['ped', 'head']
color_list = np.array(
        [
            1.000, 1.000, 1.000,
            0.850, 0.325, 0.098,
